...
export const metadata: Metadata = {
  title: 'Доставка и оплата | ДискиБел - Премиальные литые диски',
  description: 'Бесплатный самовывоз из АвтоМолла. Доставка по Минску и всей Беларуси. Оплата наличными, картой или безналичный расчет.',
  openGraph: {
    title: 'Доставка и оплата | ДискиБел',
    description: 'Условия доставки и способы оплаты литых дисков в магазине ДискиБел.',
    type: 'website',
  },
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground">
              Оплата производится удобным вам способом у менеджера-консультанта магазина, 
              который с радостью поможет Вам сделать окончательный выбор. Выберите подходящий 
              вариант, и мы позаботимся о том, чтобы ваши диски были доставлены в целости и сохранности.
            </p>
          </div>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "Доставка и оплата | ДискиБел",
