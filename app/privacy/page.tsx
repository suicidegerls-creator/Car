...
export const metadata: Metadata = {
  ...
  description: "Политика конфиденциальности интернет-магазина автомобильных дисков ДискиБел",
}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 mb-8">
          <p className="text-foreground leading-relaxed">
            Настоящая Политика конфиденциальности описывает, как интернет-магазин <strong>ДискиБел</strong> (далее — «мы», «наш», «Компания») собирает, использует и защищает персональные данные пользователей сайта. Используя наш сайт, вы соглашаетесь с условиями данной Политики.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <section className="bg-card border border-border rounded-2xl p-6 sm:p-8">
            ...
            <div className="ml-14 space-y-4 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-2">
                <li><strong className="text-foreground">Службы доставки:</strong> для выполнения заказа</li>
                <li><strong className="text-foreground">Платёжные системы:</strong> для обработки оплаты</li>
          ...
          <section className="bg-card border border-border rounded-2xl p-6 sm:p-8">
            ...
            <div className="ml-14 space-y-4 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-2">
                <li><strong className="text-foreground">Данные заказов:</strong> в течение 3 лет (для гарантийного обслуживания)</li>
          ...
          <section className="bg-foreground text-background rounded-2xl p-6 sm:p-8">
            ...
            <div className="ml-14 space-y-3 text-background/80">
              <p>По вопросам, связанным с персональными данными, вы можете связаться с нами:</p>
              <div className="space-y-2 mt-4">
                <p><strong className="text-background">Телефон:</strong> +375 (29) 657-69-60</p>
                <p><strong className="text-background">Telegram:</strong> @diskibel</p>
                <p><strong className="text-background">Адрес:</strong> г. Минск, АвтоМолл, павильон 276</p>
              </div>
            </div>
          </section>
