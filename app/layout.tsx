...
export const metadata: Metadata = {
  ...
  description: 'Интернет-магазин литых и кованых дисков в Минске. Большой выбор дисков BBS, OZ Racing, Enkei, Vossen, iFree. Датчики давления шин TPMS, крепёж, центровочные кольца, проставки. Бесплатная примерка на ваш автомобиль. Доставка по Беларуси. Тел: +375 (29) 657-69-60',
  keywords: [
    'литые диски Минск',
